                ...
                try
                    {
                        ...
                        {
                            String q1="update addbook set issuebook=issuebook*1 where id='"+bookno+"'";
                            String q2="update addbook set quantity=quantity+1 where id='"+bookno+"'";
                            ...
                            if (aaa==1)
                                {
                                    if(aaaa==1)
                                    {
                                    JOptionPane.showMessageDialog(null,"book is successfully returned and data is updated");
                                    this.setVisible(false);  
                                    }
                                    else
                                    {
